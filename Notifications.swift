...
func helpCreateNotification(contentTitle: String, contentSubTitle: String, contentBody: String, dateHour: Int, dateMinutes: Int) {
    ...
    UNUserNotificationCenter.current().add(request)  { (error) in
        if let error = error {
            print("error reminder: \(error.localizedDescription)")
        }
    }
}
...
func createPushNotifications() -> [String : [[Int: Int]]] {
    ...
    let dateHours = [10, 11, 12,13,14,15]
    let dateMinutes = [15,30,45, 0, 0, 0, 0]
    
    ["9:17", "9:30", "9:55", "10:00", "10:15", "10:30", "10:45", "11:00", "11:15", "11:30", "11:45", "12:00", "12:15", "12:30", "12:45", "13:00", "13:15", "13:30", "13:45", "14:00", "14:15", "14:30", "14:45"]
...
// use this function to remove all notifications from this app asyncronously
